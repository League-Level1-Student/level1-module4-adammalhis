...
public class SimonSays extends KeyAdapter {
	...
	public void run() {
		...
		JOptionPane.showMessageDialog(null, "Rules: Press the matching key when 'simon says' to press the key, otherwise press a different key. You must press a key to move to the next round.");
	...
	private void showImage() {
		...
		frame.setTitle("Simon Says " + " tries: " + tries + " points: " + points);
		// 9. Pack the frame
		frame.pack();
		...
		int doesSimonSay= random.nextInt(2);
